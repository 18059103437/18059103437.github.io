    ...
    <!-- user information star -->
                   	<div class="col-sm-12">
                        ...
                        <div class="nest" id="tableStaticClose">
                            <div class="title-alt">
                                <h6>
                                 <span class="icon icon-cloud"> 被叫黑名单记录</span></h6>
                            ...
                            <div class="body-nest" id="tableStatic">
								<div class="well">
                                	<ul class="datetime">
                                		<li><input class="form-control" placeholder="输入被叫手机号码" type="text" style="width:205px;"></li>
                                    ...
                                    <table class="table table-bordered table-striped cf">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>1</td>
                                                <td class="numeric">群呼</td>
                                                
                                                <td class="numeric">已解封</td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>31231214</td>
                                                ...
                                                <td class="numeric">2016/03/08~2016/06/08</td>
                                                <td>1</td>
                                                <td class="numeric">骚扰</td>
                                                
                                                <td class="numeric">解封</td>
                                            </tr><tr>
                                                <td>4</td>
                                                <td>31231214</td>
                                                <td>正常</td>
