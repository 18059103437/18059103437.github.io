    ...
    <!-- user information star -->
                   	<div class="col-sm-12">
                        ...
                        <div class="nest" id="tableStaticClose">
                            <div class="title-alt">
                                <h6><span class="icon icon-retweet"> 赠送账户补发记录</span></h6>
                            ...
                            <div class="body-nest" id="tableStatic">
								<div class="well">
                                	<ul class="datetime">
                                		<li><span>补发有效期至</span></li>
                                    	<li>
                                       	 	<input type="text" class="form-control" id="dp1" value="2016-05-10">
                                        </li>
                                        
                                        <li><span>金额</span></li>
                                        <li><input class="form-control" placeholder="正数增加，负数减少" type="text" style="width:165px;"></li>
                                        <li>
