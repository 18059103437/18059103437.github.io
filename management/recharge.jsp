...
<head>
	...
	<meta http-equiv="description" content="充值详情">
	<!--
    ...
    <!-- user information star -->
                   	<div class="col-sm-12">
                        ...
                        <div class="nest" id="tableStaticClose">
                            <div class="title-alt">
                                <h6><span class="icon icon-document">
                                   在线充值详单</span></h6>
                            ...
                            <div class="body-nest" id="tableStatic">
								<div class="well">
                                	<ul class="datetime">
                                        ...
                                        <li><span>支付状态</span></li>
                                        <li>
                                            <div class="ui-select">
                                                <select id="user_time_zone" class="form-control">
                                                    <option value="Hawaii">全部</option>
                                                    <option value="Alaska">成功</option>
                                                    <option value="Pacific Time (US &amp; Canada)">未支付</option>
                                                </select>
                                            </div>
                                        </li>
                                        <li><span>支付网关</span></li>
                                        <li>
                                            <div class="ui-select">
                                                <select id="user_time_zone2" class="form-control" style="width:135px;">
                                                    <option value="Hawaii">全部</option>
                                                    <option value="Alaska">官网-支付宝</option>
                                                    <option value="Pacific Time (US &amp; Canada)">官网-易宝</option>
                                                    <option value="Hawaii">app-支付宝</option>
                                                    <option value="Alaska">app-银联</option>
                                                    <option value="Hawaii">微信-支付宝</option>
                                                    <option value="Alaska">微信-易宝</option>
                                                </select>
                                            </div>
                                        </li>
                                        <li>
                                ...
                                <p>搜索出结果总金额：<span style="color:rgb(244, 111, 15);">5551元</span></p>
                                    ...
                                    <table class="table table-bordered table-striped cf">
                                        <thead class="cf">
                                            <tr>
                                                ...
                                                <th>下单时间</th>
                                                <th>支付金额</th>
                                                <th class="numeric">套餐名称</th>
                                                <th class="numeric">支付状态</th>
                                                <th class="numeric">支付网关</th>
                                                <th class="numeric">订单号</th>
                                                <th class="numeric">支付账户</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>2015-11-11 16:15:14</td>
                                                <td class="numeric">￥100</td>
                                                <td class="numeric">充100送50</td>
                                                <td class="numeric">成功</td>
                                                <td class="numeric">官网-支付宝</td>
                                                <td class="numeric">1051205415215</td>
                                                <td class="numeric">3046238427@qq.com</td>
